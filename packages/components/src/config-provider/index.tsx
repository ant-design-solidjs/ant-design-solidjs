...
//         childNode = (
//             <ValidateMessagesContext.Provider value={validateMessages}>{childNode}</ValidateMessagesContext.Provider>
//         );
//     }
//
//     if (locale) {
...
//
//     if (theme) {
//         childNode = <DesignTokenContext.Provider value={memoTheme}>{childNode}</DesignTokenContext.Provider>;
//     }
//
//     // ================================== Warning ===================================
//     if (memoedConfig.warning) {
//         childNode = <WarningContext.Provider value={memoedConfig.warning}>{childNode}</WarningContext.Provider>;
//     }
//
//     // =================================== Render ===================================
