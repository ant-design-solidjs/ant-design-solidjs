import type { Theme } from '@ant-design-solidjs/cssinjs';
import { useCacheToken } from '@ant-design-solidjs/cssinjs';
...
export default function useToken(): [
    ...
    const { token: rootDesignToken, hashed, theme, override, cssVar } = useContext(DesignTokenContext);
