import type { CSSObject } from '@ant-design-solidjs/cssinjs';
import { Keyframes, unit } from '@ant-design-solidjs/cssinjs';
...
const genSkeletonElementButtonShape = (token: SkeletonToken, size: number, buttonCls: string): CSSObject => {
