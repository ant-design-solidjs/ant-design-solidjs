import { get as getValue, set as setValue } from '@ant-design-solidjs/util';
import type { InternalNamePath, NamePath, Store, EventArgs } from '../interface.ts';
import { toArray } from './typeUtil.ts';
 ...
 */
export function containsNamePath(namePathList: InternalNamePath[], namePath: InternalNamePath, partialMatch = false) {
