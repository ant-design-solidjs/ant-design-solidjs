import { timeout, act } from './timeout';
...
export function matchError(wrapper: HTMLElement, error?: boolean | string, warning?: boolean | string) {
    // Error
    if (error) {
...
export function matchArray(source: any[], target: any[], matchKey: JSX.Key) {
