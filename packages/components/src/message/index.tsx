import { createSignal, onMount, Ref, useContext } from 'solid-js';
...
const GlobalHolder = (props: { messageConfig: ConfigOptions; sync: () => void; ref: Ref<GlobalHolderRef> }) => {
    const { getPrefixCls } = useContext(ConfigContext);
    const prefixCls = defaultGlobalConfig.prefixCls || getPrefixCls('message');
    const appConfig = useContext(AppConfigContext);

    const [api, holder] = useInternalMessage({ ...props.messageConfig, prefixCls, ...appConfig.message });
...
const GlobalHolderWrapper = (props: { ref: Ref<GlobalHolderRef> }) => {
    const [messageConfig, setMessageConfig] = createSignal<ConfigOptions>(getGlobalContext());
    ...
    const dom = <GlobalHolder ref={props.ref} sync={sync} messageConfig={messageConfig()} />;
    return (
