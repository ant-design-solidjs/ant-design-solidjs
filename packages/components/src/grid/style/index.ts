import { unit, type CSSObject } from '@ant-design-solidjs/cssinjs';
...
const genGridStyle = (token: GridColToken, sizeCls: string): CSSObject => genLoopGridColumnsStyle(token, sizeCls);
