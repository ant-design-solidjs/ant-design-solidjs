import { unit, CSSInterpolation, CSSObject } from '@ant-design-solidjs/cssinjs';
...
const genHoverActiveButtonStyle = (btnCls: string, hoverStyle: CSSObject, activeStyle: CSSObject): CSSObject => ({
